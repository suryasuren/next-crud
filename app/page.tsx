      ...
      <header className="py-6">
        ...
        <div className="mt-4 flex justify-center items-center">
          <input
            ...
            className="px-4 py-2 border text-black border-gray-300 rounded-l-lg focus:outline-none focus:ring focus:border-blue-300 w-64"
          />
          <button className="px-4 py-2 bg-blue-500 text-white rounded-r-lg ml-2 focus:outline-none hover:bg-blue-600">
            Search
          </button>
        </div>
      </header>
